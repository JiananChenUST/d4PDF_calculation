...
# ============================ USER CONFIGURATION ============================
OUTPUT_DIR = './4K_HA_HKU_TCWV'                    
TRACK_PATH_TEMPLATE = './Tracks/MRI_HFB_4K_HA_m{ensemble_id:03d}.nc'

Q_PATH_TEMPLATE = (
    #'nc.x/'
    #'HFB_4K_HA_m{ensemble_id:03d}/d_monit_a_nc/{year}/'
    #'q.nc'
)
...
def process_ensemble(ensemble_id: int):
    ...
    for year in range(START_YEAR, END_YEAR + 1):
        ...
        if results:
            ...
            out_file = os.path.join(OUTPUT_DIR, f'4K_HA_TCWV_multi_rad_{year}_EN_{ensemble_id:03d}.csv')
